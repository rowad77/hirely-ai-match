  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className={`text-3xl font-bold mb-8 ${rtlTextAlign}`}>{t('dashboard')}</h1>
        
        <Tabs defaultValue="saved_jobs">
          <TabsList className={`mb-6 ${rtlDirection}`}>
          ...
          <TabsContent value="applications">
            <div className={`p-8 text-center bg-gray-50 rounded-lg ${rtlTextAlign}`}>
